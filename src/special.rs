//! Special functions for the Student-t tail and the moderated-t to z
//! conversion (limma zscoreT).
//!
//! The Student-t CDF is the regularized incomplete beta via Lentz continued
//! fraction; qnorm is Acklam's rational approximation refined by one Halley
//! step. digamma/trigamma/trigamma_inverse live in rsomics-ebayes-core.
